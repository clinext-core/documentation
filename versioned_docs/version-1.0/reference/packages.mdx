...
## [CliNext Server](https://github.com/clinext-core/clinext-engine)
...
## [CliNext Manifest](https://github.com/clinext-core/clinext-manifest)
...
## [CliNext Parse Server Adapter](https://github.com/clinext-core/parse-server-engine)

The CliNext Parse Server Adapter is an example of a engine.
<BashTabs npm={`npm install @clinext/parse-server-engine`} />

## [CliNext CLI (yeoman generator)](https://github.com/clinext-core/generator-clinext)
