...
export default [
  {
    ...
    description: (
      <>
        CliNext automatically merges the user defined app schema with the features' schema.
      </>
    ),
  },
  {
...

  {
    ...
    description: (
      <>
        CliNext proposes a rolling deployment using an arbiter so that you don't mistakenly put undesired schema in production. When using this mode, both a /clinext and a /clinextstaging endpoints are exposed with separate databases for testing.
      </>
    ),
  },
