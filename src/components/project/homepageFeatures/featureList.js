...
export default [
  ...
  },
  {
    ...
    description: (
      <>
        CliNext streamlines the server development by separating every "groupable" logic to be a feature, so that it is naturally extracted from the base code and possibly migrated into its own package
      </>
    ),
  },
  {
