...
export default [
  {
    ...
    description: (
      <>
        Every feature is totally independent from other features, yet it can call CliNext's standardized api for sending emails or push notifications. A dedicated feature can register to CliNext for delivering those messages.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        A dedicated system entry in every feature allows for a custom docker-compose based infrastructure needed by the feature. The CliNext server will automatically assign free ports and run docker containers if a feature needs them.
      </>
    ),
  },
  {
