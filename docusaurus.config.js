  ...
  themeConfig:
    ...
    ({
      ...
      matomo: {
        ...
        matomoUrl: "https://matomo.clinext.app/",
        siteId: 1,
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} CliNext Community. Built with Docusaurus.`,
      },
      prism: {
        theme: lightCodeTheme,
        darkTheme: darkCodeTheme,
      },
      metadata: [{ name: 'clinext-parse', content: 'clinext, parse-server, nodejs' }],
    }),
};
