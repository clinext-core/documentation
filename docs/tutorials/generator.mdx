...
The final project is available at [https://github.com/clinext-org/generator](https://github.com/clinext-org/generator).

### What you'll need
- A Linux computer (Mac OS, Ubuntu, ...) with an internet access
- A terminal

### What you'll learn
- How to create a complete CliNext project
- How to structure questions efficiently in a project
...
## Learn more
- [Create an extension](../guides/extensions/create)
- [Sample questions](../guides/questions/samples)
